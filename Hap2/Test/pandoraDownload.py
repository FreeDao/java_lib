...
def requestFunc(id, destinationAddress):
    ...
    REQUEST_URI = 'http://nissanmip-mipgw-r3.viaaq.net/aqMIP/api/1.0/' + \
        'ProfileManager/application/appName/Pandora/appVersion/1.5/appType/HEADUNIT_APP/' \
        'startingIndex/0/mipId/0af09a52-1d77-11e2-b972-d1a8ae5d6aa1'
