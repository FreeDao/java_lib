...
PANDORA.Display = {
	...
	nowPlaying : function(data) {
		...
		template_data.template_content.buttons["2"] = {
			"image" : (data.trackRating==2) ? PANDORA.IMAGES.button['2_disliked'] : PANDORA.IMAGES.button['2_dislike'],
			"action" : (data.trackRating==2)  ? "" : "thumbsDown"
		};
		template_data.template_content.buttons["3"] = {
			"image" : (data.trackRating==1) ? PANDORA.IMAGES.button['3_liked'] : PANDORA.IMAGES.button['3_like'],
		...
		//template_data.template_content.text_left_bottom = data.artistName.toString();
