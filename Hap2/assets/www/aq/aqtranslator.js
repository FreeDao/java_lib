...
AQ.template = {
	...
	parse : function(data)
	{
		...
		//Screen id
		// TODO: generate unique screen id
		result.push({value:0x9999, length:2, name: "screen id"});
	...
	_parseListPattern : function(content, args)
	{
		...
		imageId++;
		list.image_ids.push({
			value : AQ.storage.getImageId( content.header, imageId, templateId ),
			length : 2,
		...
		for(var i=0; i<listLength; i++)
		{
			...
			//Image id
			list.image_ids.push({
				value : AQ.storage.getImageId( content.list[i].image1, imageId, templateId ),
				length : 2,
			...
			//Image hatching
			list.image_hatching.push({value:hatchingInfoImages,length:1, name:"image hatching - image 1 in list item "+listItemCount});


			//List Pattern 3
			imageId++;
			if( patternId == 3 ) //if the list pattern is 2, put the image2 in the 2nd area
			{
				//Image id
				list.image_ids.push({
					value : AQ.storage.getImageId( content.list[i].image2, imageId, templateId ),
					length : 2,
			...
			//Image hatching
            list.image_hatching.push({value:hatchingInfoImages,length:1, name:"image hatching - image 2 in list item "+listItemCount});
			...
			}else if( patternId == 3 ) //if the list pattern is 3, put the image3 in the 3rd area
			{
				//Image id
				list.image_ids.push({
					value : AQ.storage.getImageId( content.list[i].image3, imageId, templateId ),
					length : 2,
					name:"image id - image 3 in list item "+listItemCount
				});
			}else
			...
			//Image hatching
            list.image_hatching.push({value:hatchingInfoImages,length:1, name:"image hatching - image 3 in list item "+listItemCount});
	...
	b: function(data, result)
	{
		...
		var list = (function(content)
		{
			...
			//Header image id
			list.image_ids.push({
				value : AQ.storage.getImageId( content.header, imageId, 2 ),
				length : 2,
				name : "image id - header"
			});
			...
			imageId++;
			list.image_ids.push({
				value : AQ.storage.getImageId( content.image_left, imageId, 2 ),
				length : 2,
			...
			list.text_ids.push({
				value : AQ.storage.getTextId( content.text_left_top ),
				length : 2,
				name : "text id - left top"
			});

			//Left top text hatching
			list.text_hatching.push({value:hatchingInfoText,length:1,name : "text hatching info - left top"});


			//Left bottom text id - text02
			list.text_ids.push({
				value : AQ.storage.getTextId( content.text_left_bottom ),
				length : 2,
				name : "text id - left bottom"
			});

			//Left bottom text hatching
			list.text_hatching.push({value:hatchingInfoText,length:1,name : "text hatching info - left bottom"});


			//Right main text id - text03
			list.text_ids.push({
				value : AQ.storage.getTextId( content.text_right_main ),
				length : 2,
				name : "text id - right main"
			});

			//Right main text hatching
			list.text_hatching.push({value:hatchingInfoText,length:1,name : "text hatching info - right main"});
	...
	c: function(data, result)
	{
		...
		var list = (function(content, listLength)
		{
			...
			imageId++;
			list.image_ids.push({
				value : AQ.storage.getImageId( content.header, imageId, 3),
				length : 2,
				name : "image id - header"
			});
	...
	f: function(data, result)
	{
		...
		var list = (function(content)
		{
			...
			imageId++;
			list.image_ids.push({
				value : AQ.storage.getImageId( content.header, imageId, 6 ),
				length : 2,
				name : "image id - header"
			});
			...
			//Main text id
			list.text_ids.push({
				value : AQ.storage.getTextId( content.text_main ),
				length : 2,
			...
			for( var i=1; i<=3; i++ )
			{
				...
				list.text_hatching.push({value:hatchingInfoText,length:1,name:"text hatching - text item "+i});
			}
