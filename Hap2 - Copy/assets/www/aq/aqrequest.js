...
{
	//In case if it's a string, try to parse it
	try{
...
window.onNotification = function(notification)
{
	...
	{
		case "setLanguage":
			log(">>>>>>>> Set Language Request Message from Head Unit");
			// TODO: internationalize screen data based on this setting
			break;
	
		case "exit":
			log(">>>>>>>> Exit Message from Head Unit");
			// TODO: stop any audio processing
			break;
			
		case "headUnitInfo":
			log(">>>>>>>> Head Unit Info Message from Head Unit");
		...
		case "hupScreenUpdated":
			log(">>>>>>>> Display Change End Message from Head Unit");
			// TODO: safe to consider head unit screen and app IDs in sync now
			break;

		case "templateUpdated":
			log(">>>>>>>> Template Update Response Message from Head Unit");
			// TODO: try again if failure?
			break;

		case "dialResponse":
			log(">>>>>>>> Dial Response Message from Head Unit");
			// TODO: try again if failure?
			break;
	
		case "telephoneInterrupt":
			log(">>>>>>>> Telephone Interrupt Message from Head Unit");
			// TODO: stop any audio processing
			break;
			
		case "resumeApplication":
			log(">>>>>>>> Resume Application Request Message from Head Unit");
			// TODO: ACK/NAK request
			// TODO: resume any application if possible
			break;
	
		case "resumeAudioApplication":
			log(">>>>>>>> Resume Audio Application Request Message from Head Unit");
			// TODO: ACK/NAK request
