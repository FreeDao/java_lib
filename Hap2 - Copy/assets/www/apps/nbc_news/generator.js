...
NBC.Display = {
    ...
    story: function(data)
    {
        ...
        template.template_content.text_left_top = data.title || "";
        //template.template_content.text_left_bottom = data.publishDate || "";
		template.template_content.text_left_bottom = NBC.Model.shortenDate(data.publishDate) || "";//Shorten Date "08:30 PM UTC, Mon, Dec 10, 2012" To "Dec 10, 2012"
        template.template_content.text_right_main = data.content || "";
        template.template_content.image_left = data.imageURL || null;
        template.template_content.buttons = {
            1 : {
                "image" : NBC.IMAGES.button['1_tts'],
                "action" : "playTTS",
                "value" : template.template_content.text_left_top +". "+ template.template_content.text_right_main
            },
            2 : {
