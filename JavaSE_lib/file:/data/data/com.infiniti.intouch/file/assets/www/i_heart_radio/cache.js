iHR.Cache = {
	...
	getTrackName : function(){
		if(this.defaults.cache.playingState.trackInfo !=null && typeof this.defaults.cache.playingState.trackInfo.songTitle != "undefined"){
			return this.defaults.cache.playingState.trackInfo.songTitle;
		}
		return "";
	},
	
	getAlbumName : function(){
		if(this.defaults.cache.playingState.stationInfo !=null && typeof this.defaults.cache.playingState.stationInfo.name != "undefined"){
			return this.defaults.cache.playingState.stationInfo.name;
		}
		return "";
	},
	
	getArtistName : function(){
		if(this.defaults.cache.playingState.trackInfo !=null && typeof this.defaults.cache.playingState.trackInfo.artistName != "undefined"){
			return this.defaults.cache.playingState.trackInfo.artistName;
		}
		return "";
	},	
