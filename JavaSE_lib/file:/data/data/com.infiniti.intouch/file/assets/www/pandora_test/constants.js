...
PANDORA.CONFIG = {
	...
	maxImagePayloadSize : 1 * 1024, // 1KB
	cId: "APITOOL0",

	apiVersion : 3,
    accessoryId : "35772F52",
    imageType : resources.image_type.PNDR_IMAGE_PNG,
    flags : 0,
    numStationsPerPage : 101,
    trackElapsedPolling : false,
    logLevel : p_log_level.NONE
};
