...
PANDORA.Display = {
	...
	nowPlaying : function(data) {
		...
		try{
			...
			console.log( "typeof data.albumCover.image - " + typeof data.albumCover.image );
			console.log( "data.albumCover.image.length - " + data.albumCover.image.length );
		}catch(e){}
		
		//template_data.template_content.text_left_top.value = data.artistName.toString();
		//template_data.template_content.text_right_main.value = data.trackName.toString() +"\r\n"+ data.albumName.toString();
		...
		//template_data.template_content.image_left.value = albumCoverData;
		template_data.template_content.items["1"].text = data.albumName;
		template_data.template_content.items["2"].text = data.trackName;//song
		template_data.template_content.items["3"].text = data.artistName;
		template_data.template_content.items["4"].text = "";//title
		
		template_data.template_content.main_image = albumCoverData;
